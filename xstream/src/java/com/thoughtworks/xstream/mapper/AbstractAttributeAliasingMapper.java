...
public abstract class AbstractAttributeAliasingMapper extends MapperWrapper {
    ...
    protected final Map<String, String> aliasToName = new UnifiedMap<>();
    protected transient Map<String, String> nameToAlias = new UnifiedMap<>();
