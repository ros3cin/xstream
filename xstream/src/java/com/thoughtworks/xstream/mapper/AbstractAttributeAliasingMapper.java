...
public abstract class AbstractAttributeAliasingMapper extends MapperWrapper {
    ...
    protected final Map<String, String> aliasToName = new org.apache.commons.collections4.map.HashedMap<>();

    protected transient Map<String, String> nameToAlias = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    Object readResolve() {
        nameToAlias = new org.apache.commons.collections4.map.HashedMap<>();
