...
public class ImplicitCollectionMapper extends MapperWrapper {
    ...
    private final Map<Class<?>, ImplicitCollectionMapperForClass> classNameToMapper = new HashedMap<>();
    ...
    private class ImplicitCollectionMapperForClass {
        ...
        private final Map<NamedItemType, ImplicitCollectionMappingImpl> namedItemTypeToDef = new HashedMap<>();
        private final Map<String, ImplicitCollectionMappingImpl> itemFieldNameToDef = new HashedMap<>();
        private final Map<String, ImplicitCollectionMappingImpl> fieldNameToDef = new HashedMap<>();
