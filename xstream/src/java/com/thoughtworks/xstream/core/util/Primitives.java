...
public final class Primitives {
    ...
    private final static Map<Class<?>, Class<?>> BOX = new java.util.LinkedHashMap<>();

    private final static Map<Class<?>, Class<?>> UNBOX = new java.util.LinkedHashMap<>();

    private final static Map<String, Class<?>> NAMED_PRIMITIVE = new java.util.LinkedHashMap<>();

    private final static Map<Class<?>, Character> REPRESENTING_CHAR = new java.util.LinkedHashMap<>();
