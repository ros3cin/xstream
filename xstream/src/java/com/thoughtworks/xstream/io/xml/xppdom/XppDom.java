...
public class XppDom implements Serializable {
    ...
    public XppDom(final String name) {
        this.name = name;
        childList = new org.apache.commons.collections4.list.TreeList<>();
        childMap = new org.apache.commons.collections4.map.HashedMap<>();
    }
    ...
    public XppDom[] getChildren(final String name) {
        if (null == childList) {
            ...
            final java.util.List<XppDom> children = new org.apache.commons.collections4.list.TreeList<>();
    ...
    public static XppDom build(final XmlPullParser parser) throws XmlPullParserException, IOException {
        final List<XppDom> elements = new org.eclipse.collections.impl.list.mutable.FastList<>();
        final List<StringBuilder> values = new org.eclipse.collections.impl.list.mutable.FastList<>();
        XppDom node = null;
