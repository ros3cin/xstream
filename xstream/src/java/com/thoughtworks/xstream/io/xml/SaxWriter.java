...
public final class SaxWriter extends AbstractXmlWriter implements XMLReader {
     ...
     * </p>
     */
    private final Map<String, Boolean> features = new java.util.LinkedHashMap<>();
    ...
    private final List<String> elementStack = new org.apache.commons.collections4.list.TreeList<>();
